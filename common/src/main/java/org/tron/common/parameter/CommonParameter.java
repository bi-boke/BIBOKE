package org.bok.common.parameter;
...
import org.bok.core.config.args.Overlay;
import org.bok.core.config.args.SeedNode;
import org.bok.core.config.args.Storage;
...
public class CommonParameter {
  ...
  @Parameter(names = {"--contract-parse-enable"},
      description = "enable contract parses in java-bok or not.(true or false)")
  ...
  //If you are running a solidity node for java bok, this flag is set to true
  @Getter
  @Setter
