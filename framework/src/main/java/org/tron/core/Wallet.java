...
import static org.bok.common.utils.Commons.getAssetIssueStoreFinal;
import static org.bok.common.utils.Commons.getExchangeStoreFinal;
import static org.bok.common.utils.WalletUtil.isConstant;
import static org.bok.core.config.Parameter.ChainConstant.BLOCK_PRODUCED_INTERVAL;
import static org.bok.core.config.Parameter.DatabaseConstants.EXCHANGE_COUNT_LIMIT_MAX;
import static org.bok.core.config.Parameter.DatabaseConstants.PROPOSAL_COUNT_LIMIT_MAX;
...
import org.bok.api.GrpcAPI.AccountNetMessage;
import org.bok.api.GrpcAPI.AccountResourceMessage;
import org.bok.api.GrpcAPI.Address;
import org.bok.api.GrpcAPI.AssetIssueList;
import org.bok.api.GrpcAPI.BlockList;
import org.bok.api.GrpcAPI.BytesMessage;
import org.bok.api.GrpcAPI.DecryptNotes;
import org.bok.api.GrpcAPI.DecryptNotes.NoteTx;
import org.bok.api.GrpcAPI.DelegatedResourceList;
import org.bok.api.GrpcAPI.DiversifierMessage;
import org.bok.api.GrpcAPI.ExchangeList;
import org.bok.api.GrpcAPI.ExpandedSpendingKeyMessage;
import org.bok.api.GrpcAPI.IncomingViewingKeyMessage;
import org.bok.api.GrpcAPI.NfParameters;
import org.bok.api.GrpcAPI.Node;
import org.bok.api.GrpcAPI.NodeList;
import org.bok.api.GrpcAPI.NoteParameters;
import org.bok.api.GrpcAPI.NumberMessage;
import org.bok.api.GrpcAPI.PaymentAddressMessage;
import org.bok.api.GrpcAPI.PrivateParameters;
import org.bok.api.GrpcAPI.PrivateParametersWithoutAsk;
import org.bok.api.GrpcAPI.ProposalList;
import org.bok.api.GrpcAPI.ReceiveNote;
import org.bok.api.GrpcAPI.Return;
import org.bok.api.GrpcAPI.Return.response_code;
import org.bok.api.GrpcAPI.ShieldedAddressInfo;
import org.bok.api.GrpcAPI.SpendAuthSigParameters;
import org.bok.api.GrpcAPI.SpendNote;
import org.bok.api.GrpcAPI.SpendResult;
import org.bok.api.GrpcAPI.TransactionApprovedList;
import org.bok.api.GrpcAPI.TransactionExtention;
import org.bok.api.GrpcAPI.TransactionExtention.Builder;
...
import org.bok.common.overlay.discover.node.NodeHandler;
...
import org.bok.common.zksnark.IncrementalMerkleTreeContainer;
import org.bok.common.zksnark.IncrementalMerkleVoucherContainer;
import org.bok.common.zksnark.JLibrustzcash;
import org.bok.common.zksnark.LibrustzcashParam.ComputeNfParams;
import org.bok.common.zksnark.LibrustzcashParam.CrhIvkParams;
import org.bok.common.zksnark.LibrustzcashParam.IvkToPkdParams;
import org.bok.common.zksnark.LibrustzcashParam.SpendSigParams;
import org.bok.core.actuator.Actuator;
import org.bok.core.actuator.ActuatorFactory;
import org.bok.core.actuator.VMActuator;
import org.bok.core.capsule.AccountCapsule;
import org.bok.core.capsule.AssetIssueCapsule;
...
import org.bok.core.capsule.DelegatedResourceCapsule;
import org.bok.core.capsule.ExchangeCapsule;
import org.bok.core.capsule.IncrementalMerkleTreeCapsule;
import org.bok.core.capsule.IncrementalMerkleVoucherCapsule;
import org.bok.core.capsule.PedersenHashCapsule;
...
import org.bok.core.db.BandwidthProcessor;
...
import org.bok.core.exception.DupTransactionException;
import org.bok.core.exception.HeaderNotFound;
import org.bok.core.exception.ItemNotFoundException;
import org.bok.core.exception.NonUniqueObjectException;
import org.bok.core.exception.PermissionException;
import org.bok.core.exception.SignatureFormatException;
import org.bok.core.exception.StoreException;
import org.bok.core.exception.TaposException;
import org.bok.core.exception.TooBigTransactionException;
import org.bok.core.exception.TransactionExpirationException;
import org.bok.core.exception.VMIllegalException;
import org.bok.core.exception.ValidateSignatureException;
...
import org.bok.core.store.AccountIdIndexStore;
import org.bok.core.store.AccountStore;
import org.bok.core.store.ContractStore;
import org.bok.core.store.StoreFactory;
import org.bok.core.utils.TransactionUtil;
import org.bok.core.zen.ZenTransactionBuilder;
import org.bok.core.zen.address.DiversifierT;
import org.bok.core.zen.address.ExpandedSpendingKey;
import org.bok.core.zen.address.IncomingViewingKey;
import org.bok.core.zen.address.KeyIo;
import org.bok.core.zen.address.PaymentAddress;
import org.bok.core.zen.address.SpendingKey;
import org.bok.core.zen.note.Note;
import org.bok.core.zen.note.NoteEncryption.Encryption;
import org.bok.core.zen.note.OutgoingPlaintext;
...
import org.bok.protos.contract.ShieldContract.IncrementalMerkleTree;
import org.bok.protos.contract.ShieldContract.IncrementalMerkleVoucherInfo;
import org.bok.protos.contract.ShieldContract.OutputPoint;
import org.bok.protos.contract.ShieldContract.OutputPointInfo;
import org.bok.protos.contract.ShieldContract.PedersenHash;
import org.bok.protos.contract.ShieldContract.ReceiveDescription;
import org.bok.protos.contract.ShieldContract.ShieldedTransferContract;
...
public class Wallet {
  ...
  public DiversifierMessage getDiversifier() throws ZksnarkException {
    ...
    byte[] d;
    while (true) {
      d = org.bok.keystore.Wallet.generateRandomBytes(Constant.ZC_DIVERSIFIER_SIZE);
  ...
  public NodeList listNodes() {
    ...
    nodeHandlerMap.entrySet().stream()
        .forEach(v -> {
          org.bok.common.overlay.discover.node.Node node = v.getValue()
              .getNode();
