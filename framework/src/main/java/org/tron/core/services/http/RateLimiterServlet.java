...
import org.bok.core.services.ratelimiter.RateLimiterContainer;
import org.bok.core.services.ratelimiter.RuntimeData;
import org.bok.core.services.ratelimiter.adapter.DefaultBaseQqsAdapter;
import org.bok.core.services.ratelimiter.adapter.GlobalPreemptibleAdapter;
import org.bok.core.services.ratelimiter.adapter.IPQPSRateLimiterAdapter;
import org.bok.core.services.ratelimiter.adapter.IPreemptibleRateLimiter;
import org.bok.core.services.ratelimiter.adapter.IRateLimiter;
import org.bok.core.services.ratelimiter.adapter.QpsRateLimiterAdapter;

@Slf4j
public abstract class RateLimiterServlet extends HttpServlet {

  private static final String KEY_PREFIX_HTTP = "http_";
  private static final String ADAPTER_PREFIX = "org.bok.core.services.ratelimiter.adapter.";
