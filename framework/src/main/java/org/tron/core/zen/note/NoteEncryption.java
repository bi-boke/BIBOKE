package org.bok.core.zen.note;

import static org.bok.common.zksnark.JLibsodium.CRYPTO_AEAD_CHACHA20POLY1305_IETF_NPUBBYTES;
import static org.bok.core.utils.ZenChainParams.ZC_ENCCIPHERTEXT_SIZE;
import static org.bok.core.utils.ZenChainParams.ZC_ENCPLAINTEXT_SIZE;
import static org.bok.core.utils.ZenChainParams.ZC_OUTCIPHERTEXT_SIZE;
import static org.bok.core.utils.ZenChainParams.ZC_OUTPLAINTEXT_SIZE;
import static org.bok.core.zen.note.NoteEncryption.Encryption.NOTEENCRYPTION_CIPHER_KEYSIZE;
...
import org.bok.common.zksnark.JLibsodiumParam.Chacha20Poly1305IetfEncryptParams;
import org.bok.common.zksnark.JLibsodiumParam.Chacha20poly1305IetfDecryptParams;
import org.bok.common.zksnark.LibrustzcashParam.KaAgreeParams;
import org.bok.common.zksnark.LibrustzcashParam.KaDerivepublicParams;
import org.bok.core.exception.ZksnarkException;
import org.bok.core.utils.ZenChainParams;
import org.bok.core.zen.address.DiversifierT;
import org.bok.core.zen.note.NoteEncryption.Encryption.EncCiphertext;
import org.bok.core.zen.note.NoteEncryption.Encryption.EncPlaintext;
import org.bok.core.zen.note.NoteEncryption.Encryption.OutCiphertext;
import org.bok.core.zen.note.NoteEncryption.Encryption.OutPlaintext;
