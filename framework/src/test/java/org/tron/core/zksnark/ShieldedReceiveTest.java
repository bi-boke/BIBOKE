...
import org.bok.common.zksnark.LibrustzcashParam.BindingSigParams;
import org.bok.common.zksnark.LibrustzcashParam.CheckOutputParams;
import org.bok.common.zksnark.LibrustzcashParam.CheckSpendParams;
import org.bok.common.zksnark.LibrustzcashParam.IvkToPkdParams;
import org.bok.common.zksnark.LibrustzcashParam.OutputProofParams;
...
import org.bok.core.capsule.ReceiveDescriptionCapsule;
import org.bok.core.capsule.SpendDescriptionCapsule;
...
import org.bok.core.zen.ZenTransactionBuilder.ReceiveDescriptionInfo;
import org.bok.core.zen.ZenTransactionBuilder.SpendDescriptionInfo;
...
import org.bok.core.zen.note.Note.NotePlaintextEncryptionResult;
import org.bok.core.zen.note.NoteEncryption;
...
public class ShieldedReceiveTest extends BlockGenerate {
  ...
  private static byte[] randomUint256() {
    return org.bok.keystore.Wallet.generateRandomBytes(32);
  }

  private static byte[] randomUint640() {
    return org.bok.keystore.Wallet.generateRandomBytes(80);
  }

  private static byte[] randomUint1536() {
    return org.bok.keystore.Wallet.generateRandomBytes(192);
  }

  private static byte[] randomUint4640() {
    return org.bok.keystore.Wallet.generateRandomBytes(580);
  }
 ...
 */
  ...
  public void testDiversifierT() throws ZksnarkException {
    //byte[] data = org.bok.keystore.Wallet.generateRandomBytes(Constant.ZC_DIVERSIFIER_SIZE);
  ...
  public void testMemoTooLong() throws ContractValidateException, TooBigTransactionException,
    ...
    byte[] memo = org.bok.keystore.Wallet.generateRandomBytes(1024);
    ...
    for (org.bok.protos.Protocol.Transaction.Contract c : t.getRawData().getContractList()) {
  ...
  public void testMemoNotEnough() throws ContractValidateException, TooBigTransactionException,
    ...
    IncomingViewingKey incomingViewingKey = fullViewingKey.inViewingKey();
    PaymentAddress paymentAddress = incomingViewingKey.address(new DiversifierT()).get();
    byte[] memo = org.bok.keystore.Wallet.generateRandomBytes(128);
    builder.addOutput(expsk.getOvk(), paymentAddress,
        100 * 1000000L - wallet.getShieldedTransactionFee(), memo);
  ...
  public void pushSameSkAndScanAndSpend() throws Exception {
    ...
    byte[] memo = org.bok.keystore.Wallet.generateRandomBytes(512);
    ...
    for (int i = 0; i < 1; i++) {
      org.bok.api.GrpcAPI.Note grpcNote = notes1.getNoteTxs(i).getNote();
    ...
    byte[] memo3 = org.bok.keystore.Wallet.generateRandomBytes(512);
