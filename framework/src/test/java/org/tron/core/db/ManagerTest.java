...
import static org.bok.common.utils.Commons.adjustAssetBalanceV2;
import static org.bok.common.utils.Commons.adjustBalance;
import static org.bok.common.utils.Commons.adjustTotalShieldedPoolValue;
...
import org.bok.consensus.dpos.DposSlot;
...
public class ManagerTest extends BlockGenerate {
  ...
  public void updateWits() {
    ...
    WitnessCapsule witnessCapsulef =
        new WitnessCapsule(
            ByteString.copyFrom(ByteArray.fromHexString("0x0011")), "www.bok.net/first");
    ...
    WitnessCapsule witnessCapsulet =
        new WitnessCapsule(
            ByteString.copyFrom(ByteArray.fromHexString("0x0013")), "www.bok.net/three");
