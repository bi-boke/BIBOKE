contract EnergyOfTransferFailedTest {
    ...
    function testCallUnInsufficientBalance(uint256 i,address payable caller) public {
    ...
    function testSendUnNonexistentTarget(uint256 i,address payable nonexistentTarget) payable public {
        nonexistentTarget.send(i);
    }

    function testSendUnRevert(uint256 i,address payable nonexistentTarget) payable public {
        nonexistentTarget.send(i);
        revert();
    }

    function testTransferUnNonexistentTarget(uint256 i,address payable nonexistentTarget) payable public {
        nonexistentTarget.transfer(i);
    }

    function testTransferUnrevert(uint256 i,address payable nonexistentTarget) payable public{
        nonexistentTarget.transfer(i);
        revert();
    }
    ...
    function testCallUnNonexistentTarget(uint256 i,address payable nonexistentTarget) payable public {
